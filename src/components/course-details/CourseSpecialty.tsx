...
const CourseSpecialty = () => {
  return (
    <div className="relative text-white">
      <img className="h-[900px] md:h-[600px] lg:h-[500px] w-full" src={bg} alt="" />
      <h1 className="text-center absolute z-10 top-5 left-[16%] md:left-[35%] lg:left-[40%] mb-16">
        What Is The Specialty_ Of This Course?
      </h1>
      <div className="gap-4 lg:w-[70%] grid lg:grid-cols-3 grid-cols-1 md:grid-cols-2 pt-6 mt-5 absolute top-8 left-[15%]">
        <div className="border w-[300px] p-2 rounded hover:bg-[#FF978C] hover:text-black">
